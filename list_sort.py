...
lst_to_sort5 = ["002 State of Learning Checkpoint - AWS Certified Solutions Architect Associate.mp4", "004 Examples of Architecture - AWS Certified Solutions Architect Associate.mp4", "003 Exam Tips - AWS Certified Solutions Architect Associate.mp4"]

printList(sort_list3(lst_to_sort5))

# "004 Examples of Architecture - AWS Certified Solutions Architect Associate.mp4"